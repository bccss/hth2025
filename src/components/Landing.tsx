      ...
      <div className="bg-backgroundPurple justify-between w-full min-h-screen flex flex-col items-center">
        ...
        <div className="align-middle flex flex-col justify-between items-center">
          ...
          <form className="flex mt-4">
            <input type="email" placeholder="your email here" required className="bg-backgroundCream mx-5 text-fontPurple rounded-xl" />
            <button type="submit" className="bg-backgroundCream text-fontPurple mx-5 rounded-xl">send</button>
          </form>
        </div>
